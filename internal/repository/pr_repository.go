...
// 		VALUES ($1, $2, NOW(), true)
// 		ON CONFLICT (pull_request_id, reviewer_id) WHERE is_active = true
// 		DO NOTHING
// 	`
...
// 	}
// 	defer func() {
// 		// игнор ошибки Rollback, тк коммит может быть уже выполнен
// 		_ = tx.Rollback()
// 	}()
